...
namespace Harcourt\EloquentModelGenerator\Command;

use Illuminate\Config\Repository as AppConfig;
use Illuminate\Console\Command;
use Harcourt\EloquentModelGenerator\Config;
use Harcourt\EloquentModelGenerator\Generator;
use Symfony\Component\Console\Input\InputArgument;
use Symfony\Component\Console\Input\InputOption;

/**
 * Class GenerateModelCommand
 * @package Harcourt\EloquentModelGenerator\Command
 */
class GenerateModelCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'harcourt:generate:model';
